...
train_acc = pd.read_csv('results/cnn_1d/data/cnn_1d_classifier_version_0_train_acc.csv')
train_loss = pd.read_csv('results/cnn_1d/data/cnn_1d_classifier_version_0_train_loss.csv')
val_acc = pd.read_csv('results/cnn_1d/data/cnn_1d_classifier_version_0_val_acc.csv')
val_loss = pd.read_csv('results/cnn_1d/data/cnn_1d_classifier_version_0_val_loss.csv')
...
plt.figtext(.5, .95, '1D CNN Model Accuracy', fontsize='large', ha='center')
...
plt.figtext(.5, .95, '1D CNN Model Loss', fontsize='large', ha='center')
